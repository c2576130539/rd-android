...
import com.cc.rd.runtimepermissions.PermissionsManager;
import com.cc.rd.runtimepermissions.PermissionsResultAction;
...
public class HomeActivity extends BaseActivity {
    ...
    EMClientListener clientListener = new EMClientListener() {
        ...
        public void onMigrate2x(boolean success) {
            Toast.makeText(HomeActivity.this, "onUpgradeFrom 2.x to 3.x " + (success ? "success" : "fail"), Toast.LENGTH_LONG).show();
            if (success) {
