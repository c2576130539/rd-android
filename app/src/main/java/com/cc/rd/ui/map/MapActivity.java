...
import com.cc.rd.R;
import com.cc.rd.adapter.SearchResultAdapter;
import com.cc.rd.custom.SegmentedGroup;
...
public class MapActivity extends AppCompatActivity implements LocationSource,
    ...
    private AMapLocation ccAmapLocation;
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            if (result != null && result.getRegeocodeAddress() != null
                ...
                if (ccAmapLocation != null) {
                    firstItem = new PoiItem("tip", searchLatlonPoint, ccAmapLocation.getAddress(), ccAmapLocation.getAddress());
                    firstItem.setCityName(ccAmapLocation.getDistrict());
                    firstItem.setAdName("");
                } else {
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(MapActivity.this)
                    .setTitle("确认选择该位置")
                    .setMessage(poiItem.getTitle())
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(MapActivity.this, CreateOrderActivity.class);
