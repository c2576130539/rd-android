...
import com.cc.rd.R;
import com.cc.rd.adapter.BusResultListAdapter;
import com.cc.rd.util.AMapUtil;
import com.cc.rd.util.ToastUtil;
...
public class BusRouteActivity extends Activity implements OnMapClickListener,
    ...
    private LatLonPoint mStartPoint = new LatLonPoint(27.912162, 112.912096);//起点，116.335891,39.942295
    //private LatLonPoint mStartPoint = new LatLonPoint(116.335891, 27);
    //private LatLonPoint mStartPoint = new LatLonPoint(39.942295, 116.335891);//起点，116.335891,39.942295
    private LatLonPoint mEndPoint = new LatLonPoint(27.862485, 112.905944);//终点，116.481288,39.995576//112.905944,27.862485
    private String mCurrentCityName = "湘潭";
    ...
    protected void onCreate(Bundle bundle) {
        ...
        //Intent i = getIntent();
        //double j = i.getDoubleExtra("j", 6);
        //double w = i.getDoubleExtra("w", 6);
        //mStartPoint = new LatLonPoint(j, w);
